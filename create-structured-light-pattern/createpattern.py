...
import numpy as np
import cv2
import structuredlight.structuredlight.binary as sl # https://github.com/elerac/structuredlight
...
def main():
    ...
    # Generate gray code
    binary = sl.Binary()
    imlist_code = binary.generate((width, height))
    ...
    # Decode gray code
    img_index = binary.decode(imlist_observe, thresh=127)
